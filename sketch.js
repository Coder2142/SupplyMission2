...
var packageBody, ground, boxBottom,boxLeft, boxRight;
...
function setup() {
	...
	packageBody = Bodies.circle(width / 2, 200, 5, { isStatic: true, restitution: 0.8 });
...
function draw() {
	...
	packageSprite.collide(boxLeft);
	packageSprite.collide(boxRight);
